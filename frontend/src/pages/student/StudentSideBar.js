...
const studentSidebarItems = [
  ...
  { label: 'المواد', icon: <AssignmentIcon />, link: '/Student/subjects' },
  { label: 'الجدول الدراسي', icon: <ClassOutlinedIcon />, link: '/Student/schedule' },
  { label: 'الحضور', icon: <ClassOutlinedIcon />, link: '/Student/attendance' },
  { label: 'الشكوى', icon: <AnnouncementOutlinedIcon />, link: '/Student/complain' },
  { label: 'بيانات الطالب', icon: <AccountCircleOutlinedIcon />, link: '/Student/profile' },
];
...
const StudentSideBar = () => {
  ...
  return (
    <Box sx={{
      ...
      {/* Nav Items */}
      <Box sx={{ flex: 1 }}>
        {studentSidebarItems.map((item, idx) => {
